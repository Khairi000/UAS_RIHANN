      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="index.php?p=matkul"><i data-feather="book"></i><span>Mata Kuliah</span></a></li>
            <li><a class="nav-link" href="index.php?p=tambah_user"><i data-feather="user-plus"></i><span>Tambah User</span></a></li>
